...
double Util::toRadians(double degrees) { return M_PI * degrees / 180; }

double Util::toDegrees(double radians) { return 180 * radians / M_PI; }
...
double Util::convertToPercent(int t) { return map(t, -127, 127, -1, 1); };
