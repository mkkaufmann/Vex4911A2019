...
void autonomous() {
  ...
  *AsyncActionFactory::makeAsyncAction()->hasTrigger(ActionTrigger(
  ...
  AsyncAction driveToPoint2 =
  *AsyncActionFactory::makeAsyncAction()->hasTrigger(ActionTrigger(
      PositionTracker::isNearPointTrigger(20,20,1)))->hasAction(Action(
      drive.driveTowardsPointAction(20, 0),
        PositionTracker::isNearPointTrigger(20, 0, 1)));

  AsyncAction stopDriving1 = 
		*AsyncActionFactory::makeAsyncAction()->hasTrigger(ActionTrigger(
								PositionTracker::isNearPointTrigger(20, 0, 1)))->hasAction(Action(
  ...
  *AsyncActionFactory::makeAsyncAction()->hasTrigger(ActionTrigger(
    ...
    actions.push_back(driveToPoint2);
