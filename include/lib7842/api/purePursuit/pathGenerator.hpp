...
public:
   ...
   */
  static PursuitPath generate(const SimplePath &ipath,
...
protected:
  ...
  /**
   * Sets the waypoint velocities respecting curvature and deceleration.
   * Traverses the path backwards using a rate limiter.
   *
   * @param ipath  The path
   * @param limits The pure pursuit limits
   */
   ...
   */
  static double calculateCurvature(const Vector &prev, const Vector &point,
                                   const Vector &next);
};
} // namespace lib7842