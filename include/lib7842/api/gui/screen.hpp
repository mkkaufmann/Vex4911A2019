...
public:
   ...
   */
  explicit Screen(lv_obj_t *iparent, const std::shared_ptr<Logger> &ilogger =
  ...
  /**
   * Helper function to create a new page. Example use:
   * `Screen::newPage<Graph>()`. Returns a reference to the newly created page
