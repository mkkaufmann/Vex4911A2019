...
public:
  ...
  /**
   * Combine the segments each with a step of 1. Does not skip the endpoints of
   * segments. Note that if one of the segments are a nested compound path, end
   * point skipping will occur.
   *
