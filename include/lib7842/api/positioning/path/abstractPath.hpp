...
/**
 * A helper class to automatically generate the required pointer conversions for
 * each path implementation. Uses CRTP to generate the conversions. To use,
 * inherit from this class while passing the derived class as the template
 * parameter.
 *
