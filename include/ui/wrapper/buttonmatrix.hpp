...
public:
   ...
   */
  static constexpr const char *getName() { return "ButtonMatrix"; }

  /**
   * Create ButtonMatrix with no parameters. Defaults parent to lv_scr_act() and
   * copy to NULL
   */
   ...
   *
   * @param iparent the parent ButtonMatrix for this ButtonMatrix to be a child
   * of
   ...
   * @param id index of the currently toggled button (ignored if enabled is
   * false)
   */
