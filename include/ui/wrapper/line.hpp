...
public:
   ...
   */
  static constexpr const char *getName() { return "Line"; }

  /**
   * Create Line with no parameters. Defaults parent to lv_scr_act() and copy to
   * NULL
   */
  static Line create();
   ...
   * @param points an array of points (cannot be a local variable that is
   * destroyed)
