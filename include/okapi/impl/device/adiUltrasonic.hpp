...
public:
   ...
   *
   * @param iportPing The port connected to the orange OUTPUT cable. This should
   * be in the next highest port following iportEcho.
   * @param iportEcho The port connected to the yellow INPUT cable. This should
   * be in port 1, 3, 5, or 7 ('A', 'C', 'E', 'G').
